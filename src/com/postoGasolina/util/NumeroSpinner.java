 ...
 * @param <T>
 */
public class NumeroSpinner<T> extends Spinner<T> {
    ...
    private NumeroTextField numberField;
    ...
    public NumeroSpinner() {
        this(BigDecimal.ZERO, BigDecimal.ONE);
    }

    public NumeroSpinner(BigDecimal value, BigDecimal stepWidth) {
        this(value, stepWidth, NumberFormat.getInstance());
    }

    public NumeroSpinner(BigDecimal value, BigDecimal stepWidth, NumberFormat nf) {
        super();
        this.setId(NUMBER_SPINNER);
        this.stepWitdhProperty.set(stepWidth);

        // TextField
        numberField = new NumeroTextField(value, nf);
